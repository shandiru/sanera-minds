  ...
  return (
    <section className="bg-white py-16 px-6">
      <div className="max-w-4xl mx-auto space-y-6 font-body text-[#062016]/90 text-[17px] md:text-lg">
        <p data-aos="fade-up">
          We work with businesses and organisations looking to train and support
          their teams — nurseries, schools and universities embedding emotional
          resilience and self-awareness — small businesses seeking wellbeing and
          team-building — and events wanting thoughtful, wellbeing-focused
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-5" data-aos="fade-right">
          ...
          <p className="font-body text-[#062016]/90 text-[17px] md:text-lg leading-relaxed">
            We built Sanera Minds to bring learning back to life — human, warm,
