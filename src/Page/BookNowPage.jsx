  ...
  >
    ...
    <span className="font-medium">WhatsApp: +44 7414 786958</span>
        ...
        <p className="text-center text-[17px] text-[#062016]/80 mb-10 max-w-lg mx-auto">
          Book a complimentary initial assessment with one of our qualified therapists.
        </p>
        ...
        <form className="max-w-md mx-auto space-y-6">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              required
              className="w-full border border-[#cfd5cf] rounded-xl py-3 px-4 bg-white shadow-sm focus:ring-2 focus:ring-[#0a3d2f] outline-none transition"
            >
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              onChange={handleInput}
              required
              className="w-full border border-[#d6dcd6] rounded-xl py-3 px-4 shadow-sm focus:ring-2 focus:ring-[#0a3d2f] outline-none transition"
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              required
              rows="4"
              className="w-full border border-[#d6dcd6] rounded-xl py-3 px-4 shadow-sm resize-none focus:ring-2 focus:ring-[#0a3d2f] outline-none transition"
        ...
        <div className="mt-10 max-w-md mx-auto space-y-4">
          ...
          <button
            ...
            className="w-full py-3.5 rounded-xl bg-[#25D366] text-white font-semibold shadow-md hover:bg-[#1ebe5b] hover:shadow-lg transition"
          >
            Send via WhatsApp
          </button>
          ...
          <button
            onClick={sendEmail}
            className="w-full py-3.5 rounded-xl bg-[#0a3d2f] text-white font-semibold shadow-md hover:bg-[#082d22] hover:shadow-lg transition"
          >
            Send via Email
          </button>
